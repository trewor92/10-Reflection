...
namespace ReflectionApp
{
    public static class CommonTasks
    {
        ...
        /// <summary>
        /// Returns the lists of public and obsolete-устаревший classes for specified assembly.
        ...
        /// <example>
        ///  1) 
        ///  string value = instance(экземпляр).GetPropertyValue("Property1")
        ...
        public static T GetPropertyValue<T>(this object obj, string propertyPath)
        {
            ...
            return (T)propertyPath.Split('.').
                Select(x => obj.GetType().GetProperty(x)).
                Aggregate(obj, (y, x) => y = x.GetValue(y, null));
        ...
        public static void SetPropertyValue(this object obj, string propertyPath, object value)
        {
            ...
            var actualObj = properties.Count()>1? properties.Where(x => x != properties.Last()).
                Aggregate(obj, (y, x) => y = x.GetValue(y, null)): obj;

            var a = properties.Last();
            properties.Last().SetValue(actualObj, value);
